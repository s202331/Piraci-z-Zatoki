...
szczegółowych informacji na swój temat, takich jak: status cywilny, płeć,
...
znajduje się 31 brakujących wartości. W zbiorze brakuje 0,2% wartości,
w kolumnach: Income, Children, Cars, Age
...
ggplot(braki_procent, aes(x = reorder(Kolumna, -Procent), y = Procent)) +  
  ...
  theme_minimal()
```
Najwięcej braków danych występuje w kolumnie cars. 
